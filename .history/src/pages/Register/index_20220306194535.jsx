    ...
    <div>
      <Grid align="center">
        <Paper elevation={10} style={paperStyle}>
          ...
          <form>
          <TextField fullWidth label="Full Name" variant="standard" placeholder="Enter your name" />
          ...
          <TextField fullWidth label="Password" variant="standard" placeholder="Enter a password"/>
          <TextField fullWidth label="Confirm Password" variant="standard" placeholder="Enter again your password" />
